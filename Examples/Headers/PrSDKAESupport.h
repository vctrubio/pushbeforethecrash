...
#define kPFUtilitySuiteVersion10	10
#define kPFUtilitySuiteVersion11	11
#define kPFUtilitySuiteVersion		kPFUtilitySuiteVersion11
...
// PF_UtilitySuite was version 9, so we continue from there
typedef struct PF_UtilitySuite10
{
	SPAPI PF_Err(*GetFilterInstanceID)(
		PF_ProgPtr effect_ref,
		A_long* outFilterInstanceID);
	...
	SPAPI PF_Err(*IsTrackItemEffectAppliedToSynthetic)(
		PF_ProgPtr inEffectRef,
		bool* outIsTrackItemEffectAppliedToSynthetic);
	SPAPI PF_Err(*GetSourceTrackCurrentMediaTimeInfo)(
		PF_ProgPtr effect_ref,
		csSDK_uint32 inLayerParamIndex,
	...
	SPAPI PF_Err(*GetSequenceZeroPoint)(
		PF_ProgPtr inEffectRef,
		PrTime* outZeroPointTime);
} PF_UtilitySuite10;

typedef struct PF_UtilitySuite11
{
	SPAPI PF_Err(*GetFilterInstanceID)(
		PF_ProgPtr effect_ref,
		A_long* outFilterInstanceID);
	...
	/*
	** Get the duration of the clip (ie, track item) at inSequenceTime,
	** at the track specified by the param at inLayerParamIndex.
	*/
	SPAPI PF_Err(*GetSourceTrackCurrentClipDuration)(
		PF_ProgPtr inEffectRef,
		csSDK_uint32 inLayerParamIndex,
		PrTime inSequenceTime,
	...
	/*
	** Get the duration of the sequence that owns inEffectRef
	*/
	SPAPI PF_Err(*GetSequenceDuration)(
		PF_ProgPtr inEffectRef,
	...
	*/
	SPAPI PF_Err(*GetVideoResolutionString)(
		PF_ProgPtr inEffectRef,
		int32_t inSourceTrack,
		PrTime inSequenceTime,
		PrSDKString* outSDKString);
...
#define kPFSourceSettingsSuiteVersion1		1
#define kPFSourceSettingsSuiteVersion2		2
#define kPFSourceSettingsSuiteVersion		kPFSourceSettingsSuiteVersion2
...
typedef struct PF_SourceSettingsSuite
{
	...
	SPAPI PF_Err (*SetIsSourceSettingsEffect)(
		PF_ProgPtr inEffectRef,
		A_Boolean inIsSourceSettingsEffect);
} PF_SourceSettingsSuite;

typedef PF_SourceSettingsSuite PF_SourceSettingsSuite2;
